...
<body>
    <header>
        <div id="container_index">
            ...
            <nav id="nav-bar">
                <a href="http://localhost/travauxPratiques/sign_In.html">Sign in</a>
                <a href="http://localhost/travauxPratiques/sign_up.html">Sign up</a>
            </nav>
        </div>
    </header>
    ...
    <main>
        <section id="hero_banner">
            <div id="container_index2">
                <div id="title_description">
                    ...
                    <div id="button_index">
                        <button type="submit"><a href="http://localhost/travauxPratiques/sign_up.html">Sign up</a></button>
                    </div>
                </div>
                <div id="image_banner">
        ...
        <section id="filter">
            ...
            <div id="sign_in_singn_up_link">
                <p><a href="http://localhost/travauxPratiques/sign_up.html">Sign up</a> to continue or <a href="http://localhost/travauxPratiques/sign_In.html">Sign in</a></p>
            </div>
        </section>
    </main>
